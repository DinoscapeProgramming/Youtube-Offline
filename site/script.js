...
Array.apply(null, Array(Math.ceil(Object.keys(JSON.parse(fs.readFileSync("./data.json"))).length / 4))).forEach((_, videoRowIndex) => {
  ...
  Array.apply(null, Array(4)).forEach((_, videoElementIndex) => {
    ...
    videoElement.style.cursor = (((videoRowIndex * 4) + videoElementIndex) < Object.keys(JSON.parse(fs.readFileSync("./data.json"))).length) ? "pointer" : "initial";
    videoElement.style.opacity = Number(((videoRowIndex * 4) + videoElementIndex) < Object.keys(JSON.parse(fs.readFileSync("./data.json"))).length).toString();
    videoElement.style.marginRight = "10px";
    if (((videoRowIndex * 4) + videoElementIndex) < Object.keys(JSON.parse(fs.readFileSync("./data.json"))).length) {
      ...
      videoElement.addEventListener("click", () => {
        ...
        document.getElementById("videoElement").src = "../videos/" + Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex] + ".mp4";
        document.getElementById("videoElement").play();
      });
      let videoElementThumbnail = document.createElement("img");
      videoElementThumbnail.src = "../videos/" + Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex] + ".jpg";
      ...
      videoElementAuthorProfilePicture.src = "../authors/" + JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex]].authorId + ".jpg";
      ...
      videoElementTitle.innerText = JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex]].title;
      ...
      videoElementAuthorName.innerText = JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex]].authorName;
      ...
      videoElementFurtherData.innerText = (new Intl.NumberFormat()).format(JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex]].viewCount) + " Aufrufe · " + moment(JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json")))[(videoRowIndex * 4) + videoElementIndex]].publishDate).locale(navigator.language).fromNow();
...
document.getElementById("downloadButton").addEventListener("click", () => {
  let downloadVideo = (downloadLink) => {
    if (Object.keys(JSON.parse(fs.readFileSync("./data.json"))).includes(downloadLink.split("/")[3].split("=")[1].split("&")[0])) return;
      ...
      ytdl.getInfo(downloadLink).then(({
        ...
        fs.writeFile("./data.json", JSON.stringify({
          ...
          https.get(thumbnails.at(-1).url, (thumbnail) => {
            thumbnail.pipe(fs.createWriteStream("./videos/" + videoId + ".jpg"));
          });
          ...
          .then(({
            ...
            https.get(authorProfilePictureURL, (authorProfilePicture) => {
              authorProfilePicture.pipe(fs.createWriteStream("./authors/" + authorId + ".jpg"));
            });
          });
          resolve(ytmux(downloadLink).pipe(fs.createWriteStream("./videos/" + videoId + ".mp4")));
        });
      });
    });
  };
  if (document.getElementById("downloadLinkInput").value.split("/")[3].startsWith("watch")) {
    ...
    downloadVideo(document.getElementById("downloadLinkInput").value).then((downloadedVideo) => {
      downloadedVideo.on("finish", () => {
        ...
        videoElementData.style.marginTop = "8.5px";
        let videoElementAuthorProfilePicture = document.createElement("img");
        videoElementAuthorProfilePicture.src = "../authors/" + JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1)].authorId + ".jpg";
        videoElementAuthorProfilePicture.style.width = "10.5%";
        videoElementAuthorProfilePicture.style.height = "10.5%";
        videoElementAuthorProfilePicture.style.aspectRatio = "1 / 1";
        videoElementAuthorProfilePicture.style.borderRadius = "50%";
        ...
        videoElementTitle.style.whiteSpace = "nowrap";
        videoElementTitle.style.maxWidth = "calc(25vw - 60px)";
        videoElementTitle.innerText = JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1)].title;
        let videoElementAdditionalData = document.createElement("div");
        videoElementAdditionalData.style.color = "#9f9f9f";
        videoElementAdditionalData.style.fontSize = "13px";
        let videoElementAuthorName = document.createElement("p");
        videoElementAuthorName.style.margin = "0";
        videoElementAuthorName.style.paddingTop = "5px";
        videoElementAuthorName.innerText = JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1)].authorName;
        let videoElementFurtherData = document.createElement("p");
        videoElementFurtherData.style.margin = "0";
        videoElementFurtherData.style.paddingTop = "2px";
        videoElementFurtherData.innerText = (new Intl.NumberFormat()).format(JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1)].viewCount) + " Aufrufe · " + moment(JSON.parse(fs.readFileSync("./data.json"))[Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1)].publishDate).locale(navigator.language).fromNow();
        videoElementAdditionalData.appendChild(videoElementAuthorName);
        videoElementAdditionalData.appendChild(videoElementFurtherData);
        videoElementTextData.appendChild(videoElementTitle);
        videoElementTextData.appendChild(videoElementAdditionalData);
        ...
        Array.from(Array.from(document.getElementById("videoContainer").children).at(-1).children).find((videoElement) => (videoElement.style.opacity === "1") && videoElement.children[0].src.endsWith("/assets/loadingSpinner.gif")).addEventListener("click", () => {
          document.getElementById("videoSelectContainer").style.display = "none";
          document.getElementById("videoViewContainer").style.display = "flex";
          document.getElementById("videoElement").src = "../videos/" + Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1) + ".mp4";
          document.getElementById("videoElement").play();
        });
        Array.from(Array.from(document.getElementById("videoContainer").children).at(-1).children).find((videoElement) => (videoElement.style.opacity === "1") && videoElement.children[0].src.endsWith("/assets/loadingSpinner.gif")).children[0].src = "../videos/" + Object.keys(JSON.parse(fs.readFileSync("./data.json"))).at(-1) + ".jpg";
      });
    });
    ...
    ytpl(document.getElementById("downloadLinkInput").value.split("/")[3].split("=")[1].split("&")[0]).then(({ items }) => {
      items.forEach(({ shortUrl }) => {
        ...
        downloadVideo(shortUrl).then((downloadedVideo) => {
          downloadedVideo.on("finish", () => {
            let videoElementData = document.createElement("div");
            videoElementData.style.display = "flex";
            videoElementData.style.flexDirection = "row";
